from gendiff.parsing import make_format, parse_data, read_file
...
def generate_diff(first_path, second_path, formatter='stylish'):
    ...
    first_file = parse_data(read_file(first_path), first_format)
    second_file = parse_data(read_file(second_path), second_format)
