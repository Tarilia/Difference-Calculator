...
### Description:
This program allows you to compare two files with the extension .yml or .json and displays the difference in three formats to choose from: 'stylish', 'plain' and 'json'.
